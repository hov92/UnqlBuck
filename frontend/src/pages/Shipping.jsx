...
const Shipping = () => {
    ...
    const save = (e) => {
        e.preventDefault()
        const {name,address,phone,post,province,city, } = state;
        if (name && address && phone && post && province && city ) {
            setRes(true)
        }
        ...
        <div className='w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90%] mx-auto py-16'>
           <div className='w-full flex flex-wrap'>
            ...
            <div className='flex flex-col gap-1 mb-2 w-full'>
                ...
                <input onChange={inputHandle} value={state.post} type="text" className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' name="post" id="post" placeholder='Zipcode' /> 
            </div> 
            </div>
            ...
            <div className='flex flex-col gap-1 mb-2 w-full'>
                ...
                <input onChange={inputHandle} value={state.province} type="text" className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' name="province" id="province" placeholder='State' /> 
            </div>
